...
class DUAL_UR5(Task):
    ...
    def _get_eef_quat(self, state: mjx.Data) -> jax.Array:
        ...
        eef_quat = state.xquat[self.hande_id_0]  # Fixed: use hande_id_0 instead of hande_id
        return eef_quat

    def _get_eef_pos(self, state: mjx.Data) -> jax.Array:
        """Get the End Effector Frame (EEF) position."""
        tcp_pos = state.site_xpos[self.tcp_id_0]  # Fixed: use tcp_id_0 instead of tcp_id
        return tcp_pos
    ...
    def running_cost(self, state: mjx.Data, control: jax.Array) -> jax.Array:
        ...
        eef_vel_lin_0 = jacp0 @ state.qvel
        eef_vel_ang_0 = jacr0 @ state.qvel
        eef_vel_lin_1 = jacp1 @ state.qvel
        eef_vel_ang_1 = jacr1 @ state.qvel
